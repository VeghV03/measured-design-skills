---
name: designer-toolkit-design-token-audit
...
---
<!-- vendored into measured-design. upstream id: `designer-toolkit:design-token-audit` · source: designer-skills (MIT, MC Dean)
