---
name: interaction-design-navigation-patterns
...
---
<!-- vendored into measured-design. upstream id: `interaction-design:navigation-patterns` · source: designer-skills (MIT, MC Dean)
