---
name: interaction-design-gesture-patterns
...
---
<!-- vendored into measured-design. upstream id: `interaction-design:gesture-patterns` · source: designer-skills (MIT, MC Dean)
