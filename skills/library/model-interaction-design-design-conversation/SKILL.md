---
name: model-interaction-design-design-conversation
description: Design a complete human-AI conversation flow for a feature.
license: MIT
disable-model-invocation: true
---
<!-- vendored into measured-design. upstream id: `model-interaction-design:design-conversation` · source: designer-skills (MIT, MC Dean)
