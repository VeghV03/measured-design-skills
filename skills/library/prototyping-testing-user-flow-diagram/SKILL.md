---
name: prototyping-testing-user-flow-diagram
...
---
<!-- vendored into measured-design. upstream id: `prototyping-testing:user-flow-diagram` · source: designer-skills (MIT, MC Dean)
