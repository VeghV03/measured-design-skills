---
name: interaction-design-error-handling-ux
...
---
<!-- vendored into measured-design. upstream id: `interaction-design:error-handling-ux` · source: designer-skills (MIT, MC Dean)
