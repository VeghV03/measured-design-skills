---
name: ai-alignment-reasoning-transparency-patterns
description: Showing users what the AI knows, doesn't know, and how confident it is.
license: MIT
disable-model-invocation: true
---
<!-- vendored into measured-design. upstream id: `ai-alignment-reasoning:transparency-patterns` · source: designer-skills (MIT, MC Dean)
