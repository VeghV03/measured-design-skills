---
name: design-systems-documentation-template
...
---
<!-- vendored into measured-design. upstream id: `design-systems:documentation-template` · source: designer-skills (MIT, MC Dean)
