---
name: ai-alignment-reasoning-harm-anticipation
description: Proactively identifying failure modes, misuse, and unintended consequences.
license: MIT
disable-model-invocation: true
---
<!-- vendored into measured-design. upstream id: `ai-alignment-reasoning:harm-anticipation` · source: designer-skills (MIT, MC Dean)
