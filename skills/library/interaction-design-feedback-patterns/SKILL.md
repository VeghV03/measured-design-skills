---
name: interaction-design-feedback-patterns
...
---
<!-- vendored into measured-design. upstream id: `interaction-design:feedback-patterns` · source: designer-skills (MIT, MC Dean)
